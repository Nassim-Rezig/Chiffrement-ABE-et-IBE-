...
class PrescriptionAdmin(admin.ModelAdmin):
    ...
    list_display = ('consultation', 'issue_date', 'validity_days', 'display_encrypted_content')  # Ajout ici

    def display_encrypted_content(self, obj):
        """Affiche un extrait du champ binaire en Base64."""
        import base64
        if obj.encrypted_content:  # Correction ici, car vous utilisiez `encrypted_insurance`
