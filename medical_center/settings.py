...
SECRET_KEY = 'django-insecure-$1d0zw9r-zfe=zeijl41ly0$c0x*=@)e5(hjy8kb85ts!5f^v*'
...
MIDDLEWARE = [
    ...
    'accounts.middleware.RoleMiddleware',  # Notre middleware personnalisé
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Ajout du dossier templates à la racine
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
